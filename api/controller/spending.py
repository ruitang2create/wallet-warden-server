...
@router.get("/", response_model=GetSpendingListSchema)
...
@router.get("/user/{user_id}", response_model=GetSpendingListSchema)
...
@router.post("/user", response_model=GetSpendingSchema, status_code=HTTP_201_CREATED)
