...
@app.get("/incomes", response_model=GetIncomeListSchema)
...
@app.get("/incomes/user", response_model=GetIncomeListSchema)
...
@app.post("/income/user", response_model=GetIncomeSchema, status_code=HTTP_201_CREATED)
